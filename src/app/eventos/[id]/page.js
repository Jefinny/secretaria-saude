...
export default function EventosDetalhes() {
  ...
  const fotoSelecionada = fotoSelecionadaIndex !== null ? evento.galeria[fotoSelecionadaIndex] : null;
      ...
      {/* Modal para ampliar foto */}
        {fotoSelecionada && (
          <div className="modal">
            ...
            <button className="modal-prev" onClick={fotoAnterior}>❮</button>
            <div className="modal-content">
              <img src={fotoSelecionada} alt="Foto ampliada" />
            </div>
            <button className="modal-next" onClick={proximaFoto}>❯</button>
          </div>
        )}
